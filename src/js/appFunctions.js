...
class SearchBar {
    ...
    spaceSearch(spaceContainer) {
        this.inputElement.addEventListener("input", (event) => {
            ...
            this.itemList = Array.from(spaceContainer.querySelectorAll(".space-card"));
            ...
            try {
                ...
                this.itemNames.forEach((item, index) => {
                    ...
                    animate(result, "space-card-animation");
                })
            } catch (error) {
                console.error(error);
            }
...
function animate(element, animationClassName) {
...
const renderSpaces = async () => {
    try {
        ...
        for (const space of spaces) {
            ...
            animate(card, "space-card-animation");
...
`;
const newSpaceDialog = createDialog("new-space-dialog", "New space", newSpaceDialogBody);
...
const spaceSearchBar = new SearchBar(document.getElementById("space-search"));
const spaceContainer = document.getElementById("space-list");

spaceSearchBar.spaceSearch(spaceContainer);
